...
import zio._
import zio.memcached.MemcachedError.{ProtocolError, WrongType}
import zio.stream.ZStream
import zio.test.Assertion._
import zio.test._

trait SortedSetsSpec extends BaseSpec {
  def sortedSetsSuite: Spec[Memcached, MemcachedError] =
    suite("sorted sets")(
      suite("bzPopMax")(
        test("non-empty set")(
          for {
  ...
  ): ZIO[Memcached, MemcachedError, Chunk[MemberScore[String]]] =
    ZStream
